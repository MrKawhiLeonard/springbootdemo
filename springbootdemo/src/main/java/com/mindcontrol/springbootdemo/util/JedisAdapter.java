package com.mindcontrol.springbootdemo.util;
...
public class JedisAdapter implements InitializingBean {
    ...
    public static void main(String[] args){
        ...
        print(11,jedis.linsert(listName,BinaryClient.LIST_POSITION.BEFORE,"a4","yy"));
        ...
        jedis.hset(userKey,"phone","13145057138");
        ...
        jedis.hsetnx(userKey,"school","hnu");
        jedis.hsetnx(userKey,"name","lr");
        ...
        print(25,jedis.sismember(likeKey1,"10"));
        ...
        jedis.zadd(rankKey,85,"lr");
        jedis.zadd(rankKey,90,"Lee");
        jedis.zadd(rankKey,80,"Mei");
        jedis.zadd(rankKey,60,"Ben");
        print(31,jedis.zcard(rankKey));
        print(32,jedis.zcount(rankKey,61,100));
        print(33,jedis.zscore(rankKey,"lr"));
        jedis.zincrby(rankKey,3,"lr");
        print(34,jedis.zscore(rankKey,"lr"));
        jedis.zincrby(rankKey,2,"yxl");;
        print(35,jedis.zscore(rankKey,"yxl"));
        print(36,jedis.zrange(rankKey,0,100));
        print(37,jedis.zrange(rankKey,0,5));
        print(38,jedis.zrange(rankKey,1,3));
        print(39,jedis.zrevrange(rankKey,1,3));
        for (Tuple tuple : jedis.zrangeByScoreWithScores(rankKey,60,100)){
            print(40,tuple.getElement() + ":" + String.valueOf(tuple.getScore()));
        }
        print(41,jedis.zrank(rankKey,"jim"));
        print(42,jedis.zrevrank(rankKey,"jim"));
        ...
        print(46,jedis.zrange(setKey,0,10));
